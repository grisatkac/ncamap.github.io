 ...
 * PHP Proxy Client
 *
 * See https://giрзthub.com/Esri/resource-proxy for more information
 *
 */
...
class Proxy {
    ...
    public function proxyFiles()
    {
        try {
            ...
            if(curl_errno($this->ch) > 0 || empty($this->response))
            {
                ...
                $this->proxyLog->log("befor isUnauthorized()");
    ...
    public function doUserPasswordLogin() {
        ...
        $this->proxyLog->log("tokenServiceUri: " + $tokenServiceUri);

        $this->proxyPost("http://ArcGISServer:8399/arcgis/tokens", array (
                'request' => 'getToken',
                'f' => 'json',
